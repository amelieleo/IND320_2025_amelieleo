...
@st.cache_resource #Conntecing to MongoDB
def init_connection():
...
#-----------------------------------------------------------------------------------------
#----------------------------PLOTTING FUNCTIONS - WEATHER DATA----------------------------
#-----------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------
#----------------------PLOTTING ENERGY PRODUCTION DATA-----------------------------
#----------------------------------------------------------------------------------
...
if options == 'Home': #-----------------HOME PAGE-----------------------------------
    ...
    col1, col2 = st.columns(2) #splitting the slide in two
    ...
    with col1: # ---------------Price area and pie chart------------------------
        ...
        st.info("'other' groups include all categories below 2% of total (e.g. thermal, wind, solar, other).", icon="ℹ️")
    ...
    with col2: #------------------Production groups and line plot------------------------
        ...
        st.pyplot(create_lineplot_production(filtered_data_groups, price_area))
